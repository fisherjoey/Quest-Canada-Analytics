...
export default function AssessmentImportPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">Import Assessment from PDF</h1>
        ...
        <div className="border-2 border-dashed border-border rounded-lg p-8 text-center">
          ...
          {file && (
            <div className="mt-4 text-sm text-muted-foreground">
              Selected: <span className="font-medium text-foreground">{file.name}</span> ({(file.size / 1024 / 1024).toFixed(2)} MB)
            </div>
          )}
        </div>
      ...
      {isExtracting && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-card rounded-lg shadow-xl border border-border p-8 max-w-md w-full mx-4">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-2">Extracting Assessment Data</h3>
              <p className="text-muted-foreground mb-6">AI is analyzing your PDF document...</p>
              <div className="mb-4">
                ...
                <div className="w-full bg-muted rounded-full h-3 overflow-hidden">
                  <div className="bg-primary h-3 rounded-full transition-all duration-1000 ease-out" style={{ width: `${extractionProgress}%` }}></div>
                </div>
              </div>
              ...
              <p className="mt-4 text-xs text-muted-foreground">This typically takes 1-2 minutes</p>
            </div>
          </div>
        </div>
      )}
